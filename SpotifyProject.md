...
![](SpotifyProject_files/figure-markdown_github/unnamed-chunk-3-1.png)
...
![](SpotifyProject_files/figure-markdown_github/unnamed-chunk-3-2.png)
...
![](SpotifyProject_files/figure-markdown_github/unnamed-chunk-3-3.png)
...
![](SpotifyProject_files/figure-markdown_github/unnamed-chunk-3-4.png)
...
![](SpotifyProject_files/figure-markdown_github/unnamed-chunk-3-5.png)
...
```
    ...
    ##  1 Opeth       My Arms, Your H~ Demon Of ~        0.347  0.954    -5.77
    ##  2 Radiohead   In Rainbows      All I Need        0.668  0.477    -8.71
    ##  3 Cellar Dar~ The Spell        Pain              0.199  0.747    -5.86
    ##  4 Prototype   Continuum        The Way i~        0.288  0.93     -5.13
    ##  5 Toadies     Rubberneck       I Burn            0.709  0.575   -11.6 
    ##  6 A Perfect ~ TalkTalk         TalkTalk          0.406  0.738    -4.64
    ##  7 Post Malone beerbongs & ben~ Better Now        0.68   0.578    -5.80
    ##  8 Newspeak    What We Wanted   What We W~        0.658  0.881    -3.24
    ##  9 Sister Cra~ Bellow           (in) Reve~        0.277  0.477    -9.12
    ## 10 Incubus     Light Grenades   Oil and W~        0.594  0.785    -5.36
...
```
    ...
    ## Summary of sample sizes: 456, 456, 457, 456, 455, 456, ... 
    ## Resampling results:
    ## 
    ##   Accuracy   Kappa    
    ##   0.8192844  0.5353302
...
```
    ...
    ## No pre-processing
    ## Resampling: Cross-Validated (5 fold, repeated 2 times) 
    ## Summary of sample sizes: 456, 456, 455, 456, 457, 457, ... 
    ## Resampling results across tuning parameters:
    ## 
    ##   degree  scale  C     Accuracy   Kappa     
    ##   1       0.001  0.25  0.7175505  0.00000000
    ##   1       0.001  0.50  0.7175505  0.00000000
    ##   1       0.001  1.00  0.7175505  0.00000000
    ##   1       0.010  0.25  0.7175505  0.00000000
    ##   1       0.010  0.50  0.7640123  0.27182863
    ##   1       0.010  1.00  0.8131600  0.49251297
    ##   1       0.100  0.25  0.8227862  0.53298503
    ##   1       0.100  0.50  0.8201621  0.52879790
    ##   1       0.100  1.00  0.8192849  0.52851778
    ##   2       0.001  0.25  0.7175505  0.00000000
    ##   2       0.001  0.50  0.7175505  0.00000000
    ##   2       0.001  1.00  0.7175505  0.00000000
    ##   2       0.010  0.25  0.7640046  0.28152728
    ##   2       0.010  0.50  0.8140372  0.49550171
    ##   2       0.010  1.00  0.8227862  0.52743909
    ##   2       0.100  0.25  0.8087585  0.49100968
    ##   2       0.100  0.50  0.8078889  0.49412658
    ##   2       0.100  1.00  0.7973392  0.46853170
    ##   3       0.001  0.25  0.7175505  0.00000000
    ##   3       0.001  0.50  0.7175505  0.00000000
    ##   3       0.001  1.00  0.7201976  0.01567592
    ##   3       0.010  0.25  0.8114053  0.47769892
    ##   3       0.010  0.50  0.8210241  0.52154698
    ##   3       0.010  1.00  0.8184003  0.51868881
    ##   3       0.100  0.25  0.7947076  0.46683845
    ##   3       0.100  0.50  0.7877285  0.45783868
    ##   3       0.100  1.00  0.7806723  0.44700423
    ## 
...
```
    ...
    ## No pre-processing
    ## Resampling: Cross-Validated (5 fold, repeated 2 times) 
    ## Summary of sample sizes: 457, 456, 456, 455, 456, 456, ... 
    ## Resampling results across tuning parameters:
    ## 
    ##   C     Accuracy   Kappa    
    ##   0.25  0.8175409  0.5008524
    ##   0.50  0.8184181  0.5123856
    ##   1.00  0.8193030  0.5235194
    ## 
    ## Tuning parameter 'sigma' was held constant at a value of 0.05545151
    ## Accuracy was used to select the optimal model using the largest value.
    ## The final values used for the model were sigma = 0.05545151 and C = 1.
